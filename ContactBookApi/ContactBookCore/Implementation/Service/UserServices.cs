...
namespace ContactBookCore.Implementation.Service
{
    public class UserServices : IUserServices
    {
        ...
        public async Task<IActionResult> UpdateUser(string id, PutUser model)
        {
            var user = await _userManager.FindByIdAsync(id);
            if (user == null)
            {
        ...
        //public async Task<IActionResult> AddNewUser(PostNewUser model)
        //{
        //    var user = new User
        //    {
        ...
        //            ? new BadRequestObjectResult(new { Message = "Username already exists" })
        //            : new BadRequestObjectResult(new { Message = "Failed to create user" });
        //    }
